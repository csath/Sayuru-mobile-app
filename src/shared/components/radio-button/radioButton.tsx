...
import { Text, UIManager, TouchableWithoutFeedback, View, TouchableOpacity, Platform, LayoutAnimation } from 'react-native';
...
export default class RadioForm extends React.Component {
  ...
  static defaultProps = {
    radio_props: [],
    initial: 0,
    buttonColor: colors.typo_grey_header,
    selectedButtonColor: colors.typo_grey_header,
    formHorizontal: false,
    labelHorizontal: true,
    animation: true,
    labelColor: colors.typo_grey_header,
    selectedLabelColor: colors.typo_grey_header,
    wrapStyle: {},
    disabled: false,
  }
...
export class RadioButtonInput extends React.Component {
  ...
  render() {
    ...
    if (this.props.buttonSize) {
      ...
      outerSize.borderRadius = (this.props.buttonSize + 10) / 3
    }
    ...
    return (
      <View style={this.props.buttonWrapStyle} >
        <TouchableOpacity
          ...
          testID={this.props.testID}
          style={radioStyle}
          hitSlop={{top: scale(10), bottom: scale(10), left: scale(50), right: scale(150)}}
